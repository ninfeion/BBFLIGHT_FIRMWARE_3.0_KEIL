...
#define LF_CONFIG							0X1A //低通滤波器  典型值0x06 5hz
#define GYRO_CONFIG					0X1B //陀螺仪测量范围 0X18 正负2000度 (0x00 +-2g;)  ( 0x08 +-4g;)  (0x10 +-8g;)  (0x18 +-16g)
#define ACCEL_CONFIG_RANGE				0X1C //加速度计测量范围 0X18 正负16g
#define ACCEL_CONFIG_LF				0X1D //加速度计低通滤波器 0x06 5hz
