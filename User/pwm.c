...
uint8_t MOTO_Init(const MOTO_DEF *MOTO_MAP)
{
	...
	TIM_TimeBaseStructure.TIM_ClockDivision = 0;      //0+1 = 不分频
...
{		
	...
	MOTO_A.TIMX->CCR4 = MOTO1_PWM; //T4C4
    MOTO_B.TIMX->CCR3 = MOTO2_PWM; //T3C3
    MOTO_C.TIMX->CCR3 = MOTO3_PWM; //T4C3
    MOTO_D.TIMX->CCR4 = MOTO4_PWM; //T3C4
}
