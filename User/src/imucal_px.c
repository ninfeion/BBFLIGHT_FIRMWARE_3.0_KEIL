...
void IMUSO3Thread(ImuData *tarData)
{
	...
	gyro[2] = tarData->gyroRaw.newData[2] / RADTODEG;

	acc[0] = tarData->accelRaw[0];
	acc[1] = tarData->accelRaw[1];
	acc[2] = tarData->accelRaw[2];
	
	mag[0] = tarData->magRaw[0];
	mag[1] = tarData->magRaw[1];
	mag[2] = tarData->magRaw[2];
    ...
    tarData->actualPitch.newData  = euler[1] * RADTODEG;
	tarData->actualRoll.lastData  = tarData->actualRoll.newData;
    tarData->actualRoll.newData   = euler[0] * RADTODEG;
	tarData->actualYaw.lastData   = tarData->actualYaw.newData;
	tarData->actualYaw.newData    = euler[2] * RADTODEG;
} 
