...
uint8_t radioFlag, attitudeUpdateFlag, rxTimeOutFlag, batteryCheckFlag, motorUpdateFlag;
volatile uint16_t radioPeriodCount, attitudeUpdatePeriodCount, rxTimeOutCount, batteryCheckCount, motorUpdateCount;
